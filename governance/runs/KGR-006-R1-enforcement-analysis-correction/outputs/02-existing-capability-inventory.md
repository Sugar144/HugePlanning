...
The four dependencies are canonicalized only in the YAML matrix as SD-001/ER-007, SD-002/ER-012, SD-003/ER-015, and SD-004/ER-019; each requirement references its dependency ID. Do not process sensitive, regulated, confidential, or actively harmful real data until the applicable boundary is established.
